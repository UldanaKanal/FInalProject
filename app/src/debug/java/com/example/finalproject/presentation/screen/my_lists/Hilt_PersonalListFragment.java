 ...
 */
public abstract class Hilt_PersonalListFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PersonalListFragment_GeneratedInjector) this.generatedComponent()).injectPersonalListFragment(UnsafeCasts.<PersonalListFragment>unsafeCast(this));
    }
  }
