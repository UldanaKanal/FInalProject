 ...
 */
public abstract class Hilt_SimilarMoviesFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SimilarMoviesFragment_GeneratedInjector) this.generatedComponent()).injectSimilarMoviesFragment(UnsafeCasts.<SimilarMoviesFragment>unsafeCast(this));
    }
  }
