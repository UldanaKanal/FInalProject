 ...
 */
public abstract class Hilt_MyListsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyListsFragment() {
    super();
  }

  Hilt_MyListsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyListsFragment_GeneratedInjector) this.generatedComponent()).injectMyListsFragment(UnsafeCasts.<MyListsFragment>unsafeCast(this));
    }
  }
